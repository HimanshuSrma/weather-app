...
//     `https://api.weatherapi.com/v1/forecast.json?key=e9f03c0935864a1ba58105924231102&q=New%20Delhi&days=7`
//   );
...
async function getData() {
  ...
  const inputValue = inputBox.value.replace(/^\s+|\s+$/gm, '').replace(/ /g, "%20");;
  await fetch(
